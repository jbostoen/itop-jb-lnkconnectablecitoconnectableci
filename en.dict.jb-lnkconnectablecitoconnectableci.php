...
Dict::Add('EN US', 'English', 'English', array(
	...
	'Class:lnkConnectableCIToConnectableCI+' => '',
	'Class:lnkConnectableCIToConnectableCI/Attribute:device1_id' => 'Device #1',
	'Class:lnkConnectableCIToConnectableCI/Attribute:device1_id+' => '',
	'Class:lnkConnectableCIToConnectableCI/Attribute:device1_name' => 'Device #1 name',
	'Class:lnkConnectableCIToConnectableCI/Attribute:device1_name+' => '',
	'Class:lnkConnectableCIToConnectableCI/Attribute:device1_port1' => 'Device #1 port',
	'Class:lnkConnectableCIToConnectableCI/Attribute:device1_port1+' => '',
	'Class:lnkConnectableCIToConnectableCI/Attribute:device2_id' => 'Device #2 device',
	'Class:lnkConnectableCIToConnectableCI/Attribute:device2_id+' => '',
	'Class:lnkConnectableCIToConnectableCI/Attribute:device2_name' => 'Device #2 name',
	'Class:lnkConnectableCIToConnectableCI/Attribute:device2_name+' => '',
	'Class:lnkConnectableCIToConnectableCI/Attribute:device2_port' => 'Device #2 port',
	...
	'Class:lnkConnectableCIToConnectableCI/Attribute:cable_type+' => 'Cable type: ethernet cable (RJ45), optical fiber cable, USB, ...',
